...
describe('injector', function () {
  ...
  it('invokes an annotated function with depedency injection', function() {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
  ...
  it('overrides depedencies with locals when invoking', function() {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
...
describe('annotate', function () {
  ...
  it('invokes an array-annotated function with depedency injection', function() {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
  ...
  it('invokes an non-annotated function with depedency injection', function() {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
  ...
  it('instantiates an non-annotated constructor function', function() {
    var module = angular.module('myModule', []);
    module.constant('a', 1);
    module.constant('b', 2);
    var injector = createInjector(['myModule']);
  ...
  it('registers costants first to make them available to providers', function() {
    var module = angular.module('myModule', []);
  ...
  it('runs run block when the injector is created', function() {
    var module = angular.module('myModule', []);
  ...
  it('uses depedency injection with decorators', function() {
    var module = angular.module('myModule', []);
    module.factory('aValue', function() {
      return {};
    });
