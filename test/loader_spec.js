...
describe('setupModuleLoader', function() {
  ...
  it('expose the angular module function', function() {
    setupModuleLoader(window);
    expect(window.angular.module).toBeDefined();
  });

  it('expose the angular module function just once', function() {
    setupModuleLoader(window);
...
describe('modules', function () {
  ...
  it('attachrs the requires array to the registered module', function() {
