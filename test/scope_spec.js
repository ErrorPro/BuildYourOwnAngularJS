describe('Scope', function() {
  ...
  describe('digest', function() {
    ...
    it('calls the function with the scope as the argument', function() {
    ...
    it('doesnt end digest so that new watchers are not run', function() {
      scope.aValue = 'abc';
      scope.counter = 0;
    ...
    it('coalese many calls to $applyAsync', function(done) {
      scope.counter = 0;

      scope.$watch(
        function(scope) { scope.counter++; return scope.aValue },
        function(newValue, oldValue, scope) {}
      );
    ...
    it('allows destroying a $watch with removal function', function() {
      scope.aValue = 'abc';
      scope.counter = 0;
  ...
  describe('inheritance', function() {
    it('inheritance the parents properties', function() {
    ...
    it('doesnt cause a parent to inherit its properties', function() {
      var parent = new Scope();
    ...
    it('doesnt digest its parent', function() {
      var parent = new Scope();
      var child = parent.$new();
    ...
    it('doesnt have access to parent attributes when isolated', function() {
      var parent = new Scope();
  ...
  describe('$watchCollection', function() {
    ...
    it('notice an item removed from an array', function() {
      scope.arr = [1, 2, 3];
      scope.counter = 0;
    ...
    it('does consider any object with a length property an array', function() {
    ...
    it('gives the old non-collections value to listeners', function() {
      scope.aValue = 42;
      var oldValueGiven;
  ...
  describe('Events', function() {
    ...
    _.forEach(['$emit', '$broadcast'], function(method) {
      ...
      it('returns the event object on ' + method, function() {
        var returnedValue = scope[method]('someEvent');

        expect(returnedValue).toBeDefined();
        expect(returnedValue.name).toBe('someEvent');
      });
    ...
    it('propagates the same event up on $emit', function() {
      ...
      expect(parentEvent).toEqual(scopeEvent);
    });
    ...
    it('is recieved by listeners on current scope after being sropped', function() {
      var listener1 = function(event) {
        event.stopPropagation();
      };
      var listener2 = jasmine.createSpy();
