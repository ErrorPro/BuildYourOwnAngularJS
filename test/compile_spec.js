...
describe('$compile', function () {
  ...
  it('compiles element directives found from several element', function() {
    var idx = 1;
    var injector = makeInjectorWithDirectives('myDirective', function() {
      return {
        restrict: 'EACM',
  ...
  it('compiles attribute directives with prefix', function() {
    var injector = makeInjectorWithDirectives('myDirective', function() {
      return {
        restrict: 'EACM',
        compile: function(element) {
  ...
  it('compiles several class directives in an element', function() {
    ...
    injector.invoke(function($compile) {
      var el = $('<div class="my-directive my-second-directive">');
      $compile(el);
      expect(el.data('hasCompiled')).toBe(true);
      expect(el.data('secondCompiled')).toBe(true);
    });
  ...
  it('compiles class directives with prefix', function() {
    var injector = makeInjectorWithDirectives('myDirective', function() {
      return {
        restrict: 'EACM',
        compile: function(element) {
  ...
  it('applies to attributes when no resrtict given', function() {
    var hasCompiled = false;
    var injector = makeInjectorWithDirectives('myDirective', function() {
      return {
        compile: function(element) {
  ...
  it('applies to elements when no resrtict given', function() {
    var hasCompiled = false;
    var injector = makeInjectorWithDirectives('myDirective', function() {
      return {
        compile: function(element) {
  ...
  describe('attributes', function () {
    ...
    it('sets prop for boolean attribute', function() {
      registerAndCompile(
        'myDirective',
        '<input my-directive>',
        function(element, attrs) {
    ...
    it('sets prop for boolean attribute even when not flushing', function() {
      registerAndCompile(
        'myDirective',
        '<input my-directive>',
        function(element, attrs) {
    ...
    it('denormalized attribute name when explicity given', function() {
      registerAndCompile(
        'myDirective',
    ...
    it('do not use ng-attr prefix in denormalizes names', function() {
      registerAndCompile(
        'myDirective',
    ...
    it('lets observers be derigestered', function() {
      registerAndCompile(
        'myDirective',
        '<my-directive some-attribute="42"></my-directive>',
        function(element, attrs) {
    ...
    it('support values for class directive attribute', function() {
      registerAndCompile(
        'myDirective',
    ...
    it('adds on attribute with a value from a comment directive', function() {
      registerAndCompile(
        'myDirective',
    ...
    it('allows udating classes', function() {
      registerAndCompile(
        'myDirective',
  ...
  describe('linking', function () {
    ...
    it('invokes multi-element directive link function with whole group', function() {
      var givenElements;
      var injector = makeInjectorWithDirectives('myDirective', function() {
        return {
          multiElement: true,
    ...
    it('can watch isolate scope expressions as colletions', function() {
      var givenScope;
      var injector = makeInjectorWithDirectives('myDirective', function() {
        return {
          scope: {
    ...
    it('allows passing arguments to parent scope expressions', function() {
      var givenScope;
      var injector = makeInjectorWithDirectives('myDirective', function() {
        return {
          scope: {
  ...
  describe('templateUrl', function() {
    ...
    it('links when templates arrives is node link fn was called', function() {
      var linkSpy = jasmine.createSpy();
      var injector = makeInjectorWithDirectives({
        myDirective: function() {
          return {
      ...
      injector.invoke(function($compile, $rootScope) {
        var el = $('<div my-directive></div>');
        var linkFn = $compile(el)($rootScope);
        $rootScope.$apply();
