...
describe('$q', function () {
  ...
  it('allows chaining handlers', function() {
    ...
    expect(fullFillSpy).toHaveBeenCalledWith(42);
  });
  ...
  it('does not modify original resolution in chains', function() {
    ...
    expect(fullFillSpy).toHaveBeenCalledWith(20);
  });

  it('cathes rejection on chained handler', function() {
    var d = $q.defer();
  ...
  it('fullfills on chained handler', function() {
    ...
    var fullFillSpy = jasmine.createSpy();
    d.promise.catch(_.noop).then(fullFillSpy);
  ...
  it('rejected when promise returned from handler rejects', function() {
    var d = $q.defer();
    var rejectedSpy = jasmine.createSpy();
  ...
  it('allows chaining handlers on finally, with original value', function() {
    ...
    expect(fullFillSpy).toHaveBeenCalledWith(21);
  });
  ...
  it('reject to original value when nested promise resolves', function() {
    var d = $q.defer();
  ...
  it('recovers from progressBack exceptions', function() {
    ...
    d.promise.then(fullFillSpy, null, progressSpy);
